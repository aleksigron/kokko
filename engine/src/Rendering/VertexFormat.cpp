...
VertexAttribute VertexAttribute::tan = VertexAttribute(VertexFormat::AttributeIndexTan, 3);
VertexAttribute VertexAttribute::bit = VertexAttribute(VertexFormat::AttributeIndexBit, 3);
