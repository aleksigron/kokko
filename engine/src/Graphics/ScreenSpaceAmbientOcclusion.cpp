...
void ScreenSpaceAmbientOcclusion::Initialize()
{
	...
	kokko::ConstStringView shaderPaths[] = {
...
void ScreenSpaceAmbientOcclusion::CreatePassResources(size_t passCount, const kokko::ConstStringView* shaderPaths, const size_t* uniformSizes)
{
